                ...
                if (denuncia.IdAnuncio) {
                    promises.push(
                        fetch(`${API_URL}/anuncios/${denuncia.IdAnuncio}`)
                            ...
                            .catch(err => console.error(`Erro ao buscar anúncio ${denuncia.IdAnuncio}:`, err))
                    );
                }
                ...
                if (denuncia.IdUtilizadorDenunciado) {
                    promises.push(
                        fetch(`${API_URL}/utilizadores/${denuncia.IdUtilizadorDenunciado}`)
                            ...
                            .catch(err => console.error(`Erro ao buscar utilizador ${denuncia.IdUtilizadorDenunciado}:`, err))
                    );
                }
